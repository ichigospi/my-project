...
const PRESET_DEFAULTS_VERSION = 6;
...
## 基本構成
① 冒頭フック（0:00-0:30）: 結論の予告＋意外性（「金運がある人は◯◯をしません」型の常識破壊、または「これを知るだけで◯◯が変わる」型の約束）
② 問題提起・共感（〜2:00）: 視聴者の現状（頑張っているのに変わらない等）を言語化し、「原因はあなたの努力不足ではなく◯◯」と再定義
