...
const PRESET_DEFAULTS_VERSION = 3;
...
- 終盤の無料鑑定で視る対象も金運に合わせる（お金の流れが変わる時期・受け取りを止めている原因の手前まで＝メッセージ提供。具体の本音や波動調整は有料領域）`,
    ...
    targetWordCount: 4500, hookPattern: "選民宣言（おめでとう/選ばれた）＋理想の未来の肯定＋最後のカード予告", ctaPattern: "軽CTAは序盤1回（コメント一言＋高評価＋登録）／重CTAは無料霊視タロット鑑定の一本", notes: "ローラン式5枚。金運フォーカス。恋愛の顧客心理は混同しない（ただし元ネタが複数ジャンル並列なら元ネタに合わせてよい）" },
