...
D. CTAロジックの自然な連結
   ...
   - 【予祝コメントは完了形か】コメント誘導の例文が「叶いました/受け取りました」型の完了形（予祝）になっているか。
     「〜したい」「〜しますように」等の願望形の例文は予祝として機能しないため fail
...
- 「予祝コメント」の行は【完了形で書かせているか】を基準に採点する。「〜しますように」「〜したい」等の願望形の例文は予祝として機能しないため △以下とする。
