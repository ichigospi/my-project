...
2. 第1CTA（軽め・心理ハードル低）+ 例文3パターン + 社会的証明
   ...
   - 直後に「以前○○と書いた方が翌月××になった」型の社会的証明を1件入れる
...
【文字数の目標（必達）】
- 台本全体の目標文字数は「4,000〜5,000文字」とする。これを超える分量の構成にしない（セクションを増やしすぎない・各セクションを詰め込みすぎない）。
- 骨組みの「目標文字数」の行には必ず「4,000〜5,000文字」と書く。6,500〜7,500文字などの大きい数字は書かない。
