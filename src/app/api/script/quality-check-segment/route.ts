...
【評価観点 / 4カテゴリ】
A. 構成ルール遵守 … 下記【台本ルール】の構成・口調・書式・CTAルールに沿っているか（このパートの範囲で）。
B. 元台本からのズレ … 参考元の該当範囲の構成・訴求・具体性を継承し上位互換になっているか。フレーズ単位のパクリ（金額・比喩・疑問形の中身・体験談セリフのコピー）が無いか。
C. 表現品質 … 不自然な日本語・奇妙な体感表現（「お腹が締め付けられる」等）・共感を得にくい訴求・語尾の単調な連続・冗長な水増しが無いか。
