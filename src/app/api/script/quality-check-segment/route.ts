...
【評価観点 / 4カテゴリ】
A. 構成ルール遵守 … 下記【台本ルール】の構成・口調・書式・CTAルールに沿っているか（このパートの範囲で）。予祝コメントの例文があれば「叶いました/受け取りました」型の完了形か（願望形「〜しますように/〜したい」は予祝にならないためfail）。ヒーリングパートがあれば「体の変化（体感を確認させる問いかけ）」と「内側の変化（変容の意味付け宣言。例: これで億を受け取る器ができました）」の両方がセットで入っているか（体感だけ・意味付けだけの片方はwarn、両方無ければfail）。
