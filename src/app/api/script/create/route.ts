...
B. 軽CTAの3例文
   ...
   - 【予祝＝完了形（必達）】予祝コメントの例文は「すでに叶った体の完了形」で書くこと。
     良い例:「白蛇様、宝くじ当選ありがとうございました」「大金を受け取りました。感謝します」
     悪い例（願望形は禁止）:「当たりますように」「受け取りたいです」「〜してほしい」
     予祝とは"先に叶ったことにして感謝する"行為。願望を書かせたら予祝にならない。
