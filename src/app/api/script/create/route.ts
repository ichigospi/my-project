...
【テーマ／タイトル】${topic}
【スタイル】${style === "healing" ? "ヒーリング系（癒し・瞑想・エネルギーワーク中心）" : style === "tarot" ? "タロット系（3つの山から視聴者が直感で選ぶカード鑑定。各山ごとにメッセージを届ける構成。引いたカードの象徴と読み解きを軸に語る）" : "解説・教育系（知識・解説中心）"}
${profileText}
${referenceText}
...
- ${style === "healing" ? "癒しと安心感を与える穏やかなトーン" : style === "tarot" ? "カードの象徴と対話するような神秘的で温かいトーン。山ごとのパートは独立して完結させる" : "わかりやすく知識を伝える信頼感のあるトーン"}
