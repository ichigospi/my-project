...
- 【ヒーリングパートの変化の過程（必達）】ヒーリングパートには「体の変化」と「内側の変化」の両方を必ずセットで入れる。
  ・体の変化: 今この瞬間の身体感覚を確認させる問いかけ（例:「だんだん胸のあたりが、じんわり温こうなってきてませんか？」）
  ・内側の変化: その体感が何を意味するかの内的変容の宣言（例:「これであんたの中に、億を受け取る器ができたんや」）
  順番は「体の変化（体感の確認）→ 内側の変化（変容の意味付け）」。体感の描写だけで終わらせない・意味付けだけで済ませない。骨組みにこの過程が書かれていれば必ずその通りに書く
