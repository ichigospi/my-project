...
function IconView({ notif, badge }: { notif: NotifItem; badge?: number }) {
  return (
    <div className="relative shrink-0">
      {notif.iconUrl ? (
        <div
      className="w-[42px] h-[42px] rounded-[10px] bg-cover bg-center"
          style={{ backgroundImage: `url(${notif.iconUrl})` }}
        />
      ) : (
        <div
      className="w-[42px] h-[42px] rounded-[10px] flex items-center justify-center text-white font-bold text-base"
      ...
      <div className="relative px-3.5 py-3.5 flex gap-3.5 items-center">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-baseline justify-between gap-2">
            ...
            <p className="text-white/50 text-[13px] shrink-0 tabular-nums">
              {notif.time}
            </p>
          </div>
